// Template served at GET /install. The worker fills the three
// __SWORM_*__ placeholders before serving. Keep install/install.sh in
// sync with this file so anyone can read in the repo exactly what the
// pipe-to-bash command runs.
//
// The script must stay free of backticks and ${...} so it can live
// inside this javascript template literal.
