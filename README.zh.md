...
<p align="center"><b>一种可通过代码文件、文件夹或 APK 等安装到任意设备上的蠕虫，对用户静默运行且屏幕上不显示任何通知或弹窗，隐藏于 RAM 中，并通过你的 CLI 进行控制。</b></p>
...
$\color{red}{\textsf{sworm 用于有益、积极、合规的用途。作者不对非合规使用负责。}}$

一种可通过代码文件、文件夹或 APK 等安装到任意设备上的蠕虫，对用户静默运行且屏幕上不显示任何通知或弹窗，隐藏于 RAM 中，并通过你的 CLI 进行控制。
