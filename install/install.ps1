# sworm installer for windows.
#
# This is the repo copy of the script your worker serves at
# GET /install.ps1. The worker fills the three __SWORM_*__ placeholders
# when it serves it. To run this copy by hand, fill the three lines
# below first.
#
