...
sworm ایک شفاف، self-hostable ریموٹ ڈیوائس مینجمنٹ ٹول ہے۔ آپ ایک cloudflare worker deploy کرتے ہیں، اپنی مینج کی جانے والی مشینوں پر ایک چھوٹا node agent لگاتے ہیں، اور پورے بیڑے کو ایک CLI سے چلاتے ہیں: مشینوں کی فہرست، ان کے ڈسک دیکھنا، فائلیں بھیجنا اور واپس لانا، کمانڈز چلانا، paths حذف کرنا، اور کسی کے چھوڑنے پر scoped wipe۔

عام MDM ٹولز بھاری، مہنگے اور بند ہوتے ہیں۔ sworm اس کا الٹ ہے: ایک worker، ایک پڑھنے کے قابل agent فائل، ایک CLI۔ مینج کی گئی مشین پر چلنے والی ہر سطر اسی repo میں ہے، اور agent سادہ javascript ہے جسے آپ چند منٹ میں پڑھ سکتے ہیں۔
